...
public interface TiledLayers {
    ...
    // table
    String ACTORS_LAYER_DICTOPHONES = "dictophones";
    String ACTORS_LAYER_STRESS_LEVELS = "stress_levels";

    String TEA = "tea";
    String STRESS_LEVELS = "stress_levels";

    String DAILY = "daily";
    String DAILY_HELL_VERSION = "hell_version";
